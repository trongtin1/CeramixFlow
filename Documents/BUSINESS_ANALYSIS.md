...
1. **Hiệu năng & Độ trễ (Performance):**
   - Áp dụng mô hình **Optimistic UI**: Mọi tương tác người dùng (chuyển trạm, kéo thả, chỉnh sửa) phản hồi trên giao diện tại **0ms**, việc đồng bộ cơ sở dữ liệu và gọi Telegram API diễn ra ngầm ở background.
